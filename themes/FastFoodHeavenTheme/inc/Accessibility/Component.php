...
class Component implements Component_Interface {
	...
	public function action_enqueue_navigation_script() {
		...
		wp_enqueue_script(
			'FastFoodHeavenTheme-navigation',
			get_theme_file_uri( '/assets/js/navigation.min.js' ),
			array(),
			FastFoodHeavenTheme()->get_asset_version( get_theme_file_path( '/assets/js/navigation.min.js' ) ),
			false
		);
		wp_script_add_data( 'FastFoodHeavenTheme-navigation', 'async', true );
		wp_script_add_data( 'FastFoodHeavenTheme-navigation', 'precache', true );
		wp_localize_script(
			'FastFoodHeavenTheme-navigation',
			'fastFoodHeavenThemeScreenReaderText',
			array(
				'expand'   => __( 'Expand child menu', 'FastFoodHeavenTheme' ),
				'collapse' => __( 'Collapse child menu', 'FastFoodHeavenTheme' ),
			)
		);
	}
