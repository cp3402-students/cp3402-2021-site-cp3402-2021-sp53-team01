 ...
 * * `FastFoodHeavenTheme()->is_primary_sidebar_active()`
 * * `FastFoodHeavenTheme()->display_primary_sidebar()`
 *
...
class Component implements Component_Interface, Templating_Component_Interface {
	...
	public function action_register_sidebars() {
		register_sidebar(
			array(
				'name'          => esc_html__( 'Sidebar', 'FastFoodHeavenTheme' ),
				'id'            => static::PRIMARY_SIDEBAR_SLUG,
				'description'   => esc_html__( 'Add widgets here.', 'FastFoodHeavenTheme' ),
