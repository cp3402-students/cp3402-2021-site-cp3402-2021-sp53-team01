...
/* global fastFoodHeavenThemeScreenReaderText */
...
function toggleSubMenu(parentMenuItem, forceToggle) {
  ...
  if (parentMenuItemToggled) {
    ...
    toggleButton.setAttribute('aria-label', fastFoodHeavenThemeScreenReaderText.expand); // Make sure all children are closed.
    ...
    toggleButton.setAttribute('aria-label', fastFoodHeavenThemeScreenReaderText.collapse);
  }
}
/**
...
function getDropdownButton() {
  ...
  dropdownButton.setAttribute('aria-label', fastFoodHeavenThemeScreenReaderText.expand);
